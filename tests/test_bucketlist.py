...
class BucketlistTestCase(unittest.TestCase):
    ...
    def test_create_bucketlist(self):
        ...
        result = self.client().post('/bucketlists/', data=json.dumps(self.bucketlist),
    ...
    def test_getall_bucketists(self):
        ...
        res_login = self.login_user()
        token = json.loads(res_login.data.decode())['token']
        bucket_post = self.client().post('/bucketlists/', data=json.dumps(self.bucketlist),
                                         headers={'Authorization': token, 'content-type': 'application/json'})
        self.assertEqual(bucket_post.status_code, 201)
        res = self.client().get(
            '/bucketlists/', headers={'Authorization': token})
    ...
    def test_bucketlist_update(self):
        ...
        put_req = self.client().put('/bucketlists/1', data=json.dumps(new_data),
                                    headers={'Authorization': token, 'content-type': 'application/json'})
        result = self.client().get('bucketlists/1',
                                   headers={'Authorization': token, 'content-type': 'application/json'})
    ...
    def test_bucketitem_create(self):
        ...
        bucket_post = self.client().post('/bucketlists/', data=json.dumps(self.bucketlist),
                                         headers={'Authorization': token, 'content-type': 'application/json'})
        result = self.client().post('/bucketlists/1/items', data=json.dumps(self.bucketitem),
                                    headers={'Authorization': token, 'content-type': 'application/json'})
    ...
    def test_get_bucketitem_update(self):
        ...
        bucket_post = self.client().post('/bucketlists/', data=json.dumps(self.bucketlist),
                                         headers={'Authorization': token, 'content-type': 'application/json'})
        bucket_item = self.client().post('/bucketlists/1/items', data=json.dumps(self.bucketitem),
                                         headers={'Authorization': token, 'content-type': 'application/json'})
        new_data = {'name': 'Go on tour'}
        put_req = self.client().put('/bucketlists/1/items/1', data=json.dumps(new_data),
                                    headers={'Authorization': token, 'content-type': 'application/json'})
    ...
    def test_bucketitem_delete(self):
        ...
        bucket_item = self.client().post('/bucketlists/1/items', data=json.dumps(self.bucketitem),
                                         headers={'Authorization': token, 'content-type': 'application/json'})
        result = self.client().delete('/bucketlists/1/items/1',
                                      headers={'Authorization': token, 'content-type': 'application/json'})
        self.assertEqual(result.status_code, 200)
